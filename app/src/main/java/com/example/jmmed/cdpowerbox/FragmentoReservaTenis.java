...
public class FragmentoReservaTenis extends Fragment{
    Retrofit retrofit;
    RestReservaTenis service;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragmento_reserva_tenis, container, false);
        firebaseAuth = FirebaseAuth.getInstance();
        database = FirebaseDatabase.getInstance();
        usuariosRef = database.getReference(FirebaseReferences.USUARIOS);
        user = firebaseAuth.getCurrentUser();
        textoUsuarioDiezAOnce= (TextView) view.findViewById(R.id.texto_tenis_10_11);
        textoUsuarioOnceADoce= (TextView) view.findViewById(R.id.texto_tenis_11_12);
        textoUsuarioDoceAUna= (TextView) view.findViewById(R.id.texto_tenis_12_13);
        textoUsuarioUnaAdos= (TextView) view.findViewById(R.id.texto_tenis_13_14);
        textoUsuarioCuatroACinco= (TextView) view.findViewById(R.id.texto_tenis_16_17);
        textoUsuarioCincoASeis= (TextView) view.findViewById(R.id.texto_tenis_17_18);
        textoUsuarioSeisASiete= (TextView) view.findViewById(R.id.texto_tenis_18_19);
        textoUsuarioSieteAOcho= (TextView) view.findViewById(R.id.texto_tenis_19_20);
        textoUsuarioOchoANueve= (TextView) view.findViewById(R.id.texto_tenis_20_21);
        textoFecha= (TextView) view.findViewById(R.id.fecha_tenis);
        SimpleDateFormat dateFormat= new SimpleDateFormat("dd-MM-yyyy");
        Date fecha=new Date();
        textoFecha.append(dateFormat.format(fecha));
        this.retrofit = Conexion.getRetrofit();
        this.service = retrofit.create(RestReservaTenis.class);


        //botones reservar
        botonDiezAOnce= (Button) view.findViewById(R.id.boton_tenis_10_11);
        ...
        botonOnceADoce= (Button) view.findViewById(R.id.boton_tenis_11_12);
        ...
        botonDoceAUna= (Button) view.findViewById(R.id.boton_tenis_12_13);
        ...
        botonUnaADos= (Button) view.findViewById(R.id.boton_tenis_13_14);
        ...
        botonCuatroACinco= (Button) view.findViewById(R.id.boton_tenis_16_17);
        ...
        botonCincoASeis= (Button) view.findViewById(R.id.boton_tenis_17_18);
        ...
        botonSeisASiete= (Button) view.findViewById(R.id.boton_tenis_18_19);
        ...
        botonSieteAOcho= (Button) view.findViewById(R.id.boton_tenis_19_20);
        ...
        botonOchoANueve= (Button) view.findViewById(R.id.boton_tenis_20_21);
        ...
        //Botones cancelar
        botonCancelarDiezAOnce= (Button) view.findViewById(R.id.boton_tenis_cancelar_10_11);
        ...
        botonCancelarOnceADoce= (Button) view.findViewById(R.id.boton_tenis_cancelar_11_12);
        ...
        botonCancelarDoceAUna= (Button) view.findViewById(R.id.boton_tenis_cancelar_12_13);
        ...
        botonCancelarUnaADos= (Button) view.findViewById(R.id.boton_tenis_cancelar_13_14);
        ...
        botonCancelarCuatroACinco= (Button) view.findViewById(R.id.boton_tenis_cancelar_16_17);
        ...
        botonCancelarCincoASeis= (Button) view.findViewById(R.id.boton_tenis_cancelar_17_18);
        ...
        botonCancelarSeisASiete= (Button) view.findViewById(R.id.boton_tenis_cancelar_18_19);
        ...
        botonCancelarSieteAOcho= (Button) view.findViewById(R.id.boton_tenis_cancelar_19_20);
        ...
        botonCancelarOchoANueve= (Button) view.findViewById(R.id.boton_tenis_cancelar_20_21);
